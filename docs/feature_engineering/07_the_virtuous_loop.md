...
[
  {
    "id": "ILL-07-00",
    "title": "Banner — The Virtuous Loop",
    "post_part": 7,
    "file": "part_07/ILL-07-00.png",
    "placement": "top_of_post",
    "alt": "Banner showing a loop from features to planner to rendered show to evaluation and back",
    "prompt": "VIEW: A wide banner of the full feedback loop: extracted features shape the planner, the planner produces a show, the show gets evaluated, and the results feed back into the pipeline.\nComposition approach: OVERHEAD VIEW with a circular loop layout.\nShow nodes for feature artifacts, planner context, rendered residential Christmas display, evaluation metrics, and refinement rules.\nUse a neighborhood house with roofline lights, arches, trees, and upright moving heads on stands or eaves as the rendered show target.",
  ...
  {
    "id": "ILL-07-01",
    "title": "Planner Context Shaping",
    "post_part": 7,
    "file": "part_07/ILL-07-01.png",
    "placement": "after_section:How the Planner Actually Uses All This Stuff",
    "alt": "Multiple feature artifacts assembled into a planner context window with labeled influence paths",
    "prompt": "VIEW: Multiple feature artifacts being assembled into a planner context window, with arrows showing how each one influences decisions without dictating them.\nComposition approach: CUTAWAY/EXPLODED.\nShow inputs: recipe catalog, color arc, propensity hints, style constraints, vocabulary extensions, transition guidance.\nCenter: planner context window card.\nOutputs: template selection, transition choice, color coherence, role assignment.\nAdd a small rendered residential display on the right to show the downstream effect.",
    "style_profile": "twinklr_sketch_light_v2",
    "model": "gpt-image-1.5",
    "size": "1024x1024",
    "type": "diagram",
  ...
  },
  {
    ...
    "post_part": 7,
    "file": "part_07/ILL-07-02.png",
    "placement": "after_section:Judge Scores, Survival Rates, and Other Imperfect but Useful Truth Serum",
    "alt": "Table of evaluation metrics, what they validate, and their failure smells",
    "prompt": "VIEW: A 4-column evaluation table summarizing the practical metrics used to judge whether the pipeline helps.\nCreate a table illustration with exact headers: Metric | Type | What It Validates | Failure Smell\nRow 1: judge score lift | extrinsic | whether planned shows feel more coherent, musical, and thematically consistent | outputs look polished locally but still feel disconnected overall\nRow 2: recipe survival | extrinsic | whether promoted recipes remain useful through planning and refinement | recipes are selected early then repeatedly replaced downstream\nRow 3: mining precision | intrinsic | whether mined templates correspond to real recurring patterns | frequent patterns collapse into noisy or trivial clusters\nRow 4: taxonomy coverage | intrinsic | whether useful corpus patterns receive actionable labels | too many templates remain unlabeled or fall into vague buckets\nRow 5: alignment accuracy | intrinsic | whether events are attached to the right beats, bars, and sections | phrases feel musically off even when effects are individually plausible\nRow 6: color consistency | extrinsic | whether section-level palette choices form a believable visual narrative | colors jump randomly or ignore section boundaries\nKeep the table exact and readable, with small festive metric icons only as accents.",
    "style_profile": "twinklr_sketch_light_v2",
    "model": "gpt-image-1.5",
    "size": "1536x1024",
    "type": "table",
    ...
    "output_format": "png",
    "quality": "high",
    "composition_approach": "TABLE_LAYOUT_EVAL"
  },
  {
    "id": "ILL-07-03",
    "title": "Discovery to Application Loop",
    "post_part": 7,
    "file": "part_07/ILL-07-03.png",
    "placement": "after_section:The Discovery-to-Application Loop, Looking Back",
    "alt": "Circular system showing discovery, experimentation, evaluation, refinement, and application with artifacts flowing between phases",
    "prompt": "VIEW: A circular system diagram showing the full discovery-to-application loop and how artifacts move between phases.\nComposition approach: GHOSTED POSITIONS.\nArrange five phases in a loop: discovery, experimentation, evaluation, refinement, application.\nBetween phases, show artifacts like thresholds, taxonomy updates, promotion rules, planner context, and rendered show outcomes.\nAdd a small note that application outcomes feed back into earlier stages. Use a tiny residential display in the application phase.",
    "style_profile": "twinklr_sketch_light_v2",
    "model": "gpt-image-1.5",
    "size": "1024x1024",
    "type": "diagram",
  ...
  },
  {
    ...
    "post_part": 7,
    "file": "part_07/ILL-07-04.png",
    "placement": "after_section:What's Next, Besides Sleep",
    "alt": "Roadmap with current pipeline stages as solid nodes and future work as dotted nodes",
    "prompt": "VIEW: A roadmap showing the current pipeline as solid nodes and future work as dotted extensions.\nComposition approach: TIMELINE AXIS.\nSolid nodes: profiling, audio features, alignment, mining, knowledge extraction, promotion, planner feedback.\nDotted future nodes: learned taxonomy v2, recipe quality scoring, cross-domain transfer, generative recipe synthesis, real-time streaming, community corpus growth.\nUse arrows to show likely evolution paths. Add a tiny neighborhood holiday display at the end of the line.",
    "style_profile": "twinklr_sketch_light_v2",
    "model": "gpt-image-1.5",
    "size": "1024x1024",
    "type": "diagram",
  ...
  {
    "id": "ILL-07-05",
    "title": "Index Card — Feedback Loop Keeps the Lights Sane",
    "post_part": 7,
    "file": "part_07/ILL-07-05.png",
    "placement": "end_of_post",
    "alt": "Thumbnail-style loop from features to planner to rendered show to evaluation score and back",
    "prompt": "VIEW: A bold square thumbnail of a loop connecting feature cards, a planner card, a rendered house display, an evaluation score badge, and an arrow back to refinement.\nComposition approach: FOCAL ZOOM with the loop large and simple.\nKeep the house clearly residential with festive roofline lights and upright moving heads on stands or eaves.",
    "style_profile": "twinklr_sketch_light_v2",
    "model": "gpt-image-1.5",
    "size": "1024x1024",
    "type": "index_card",
