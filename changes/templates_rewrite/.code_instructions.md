...
### Import Style
```python
# ✅ ALWAYS DO THIS (absolute imports)
from blinkb0t.core.curves.models import CurvePoint
from blinkb0t.core.sequencer.models.rig import RigProfile

# ❌ NEVER DO THIS (relative imports - hard review fail)
...
```
✅ Templates describe choreography (no fixture IDs)
✅ Rig profiles describe physical fixtures (no choreography)
✅ Handlers generate curves (no orchestration)
✅ Compiler orchestrates (no generation)
✅ Exporters adapt output (no logic)
...
```python
# ✅ MUST USE Option B (sampling-based)
...
# ❌ NEVER use Option A (point mutation)
...
- [ ] Task 0.3: Channel and DMX Enums (1h) - 🔄 In Progress
...
### Next Task
✅ Ready to proceed to Task 0.3: Channel and DMX Enums
```
