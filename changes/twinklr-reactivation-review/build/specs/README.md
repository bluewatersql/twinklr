...
_One spec per plan task. Generated from `changes/twinklr-reactivation-review/build/plan/*.md` + the verified review
...
- Every sequencing constraint from `changes/twinklr-reactivation-review/build/plan/00-overview.md` that touches the task
