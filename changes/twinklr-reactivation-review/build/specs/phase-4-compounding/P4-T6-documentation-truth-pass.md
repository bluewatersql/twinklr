...
| Demo/exploration, corpus-tooling | `demo_asset_pipeline.py`, `demo_display_renderer.py`, `demo_eval_report.py`, `demo_feature_engineering.py`, `demo_moving_heads_pipeline.py`, `demo_profiling.py`, `demo_recipe_builder.py`, `demo_recipe_pipeline.py` | List in a new `scripts/README.md` (see below) so they're discoverable without directory-browsing |
