...
in `changes/twinklr-reactivation-review/build/plan/03-phase-1k-knowledge-edges.md`). Do not invent a throwaway fixture format
...
- Read `changes/twinklr-reactivation-review/build/plan/03-phase-1k-knowledge-edges.md`'s P1K-T4 task row first (see "Notes
...
mitigate by checking `changes/`/`changes/twinklr-reactivation-review/build/specs/phase-1k-knowledge-edges/` for a P1K-T4 spec
