...
| 4 — Compounding | **IMPLEMENTATION IN PROGRESS** (1/7 integrated; P4-T3 author candidate frozen) | P4-T1 is integrated at `56d9aa0`. P4-T3 is implemented on isolated branch `codex/p4t3-dead-tail` from `591d1d3`, with full author suite `5220 passed, 38 skipped`; it is not approved or integrated. Exact P4-T3 scope corrections and evidence: [P4-T3 task spec](../specs/phase-4-compounding/P4-T3-dead-tail-retirement-wave-1.md). |
