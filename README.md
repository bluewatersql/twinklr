...
- **Template Composition**: Multi-step templates compose curated movement, geometry, and dimmer primitives—no raw DMX generation
...
- **Quality Assurance**: Built-in Plan → Validate → Implement → Judge → Iterate cycle ensures professional results
...
│       ├── context_shaper.py # Token-efficient context prep
│       ├── plan_generator.py # Strategic planning stage
│       ├── heuristic_validator.py # Fast validation
│       ├── implementation_expander.py # Detail stage
│       ├── judge_critic.py   # Quality evaluation
│       └── refinement_agent.py # Iteration logic
├── domains/                   # Domain Logic
│   ├── audio/                # Music analysis
│   │   ├── processor.py     # Audio processing
│   │   └── analyzer.py      # Feature extraction
│   └── sequencing/           # Sequence generation
│       ├── timing/           # Musical time abstraction
│       ├── curves/           # Value curve generation
│       ├── channels/         # DMX channel handlers
│       │   ├── handlers/    # Shutter, color, gobo
│       │   └── libraries/   # Channel pattern libraries
│       ├── moving_heads/     # Moving head sequencing
│       │   ├── templates/   # Template system
│       │   ├── poses/       # Pose abstraction
│       │   ├── libraries/   # Movement/geometry/dimmer
│       │   ├── manager.py   # Pipeline coordinator
│       │   └── sequencer.py # Rendering engine
│       └── xsq/             # xLights file format
├── models/                   # Pydantic Data Models
│   ├── templates.py         # Template definitions
│   ├── poses.py             # Pose models
│   ├── orchestration.py     # Agent models
│   └── timing.py            # Timing models
...
4. **Required Quality Loop**: Plan → Validate → Implement → Judge → Iterate
...
│   ├── sequences/          # Sample xLights sequences
│   ├── audio_cache/        # Analysis cache
│   └── v2/templates/       # Template library
├── artifacts/                # Generated outputs
├── changes/                  # Architecture docs
