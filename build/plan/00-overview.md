...
[reactivation-proposal.md (v3)](../../changes/twinklr-reactivation-review/reviews/reactivation-proposal.md).
...
- Task IDs: `P<phase>-T<n>` (e.g., `P1P-T3`). Specs live at
  `build/specs/phase-<slug>/P*-T*-<kebab-title>.md`, one file per task.
- Every spec follows the template in [`build/specs/README.md`](../specs/README.md).
