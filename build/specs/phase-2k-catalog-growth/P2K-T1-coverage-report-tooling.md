...
instrument: Phase 2K (`build/plan/05-phase-2k-catalog-growth.md`) is done only when
...
- Phase 2K exit criterion (verbatim, `build/plan/05-phase-2k-catalog-growth.md:8-11`):
