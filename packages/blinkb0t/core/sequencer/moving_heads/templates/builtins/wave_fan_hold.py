...
@register_template(aliases=["Wave Fan Hold", "wave fan hold"])
def make_template() -> TemplateDoc:
    return TemplateDoc(
        template=Template(
            template_id="wave_fan_hold",
            version=1,
            name="Wave Fan Hold",
            ...
            metadata=TemplateMetadata(
                description="Horizontal wave over fan formation with steady dimmer.",
                recommended_sections=["verse", "intro"],
                energy_range=(25, 55),
                tags=["wave", "fan", "hold", "gentle"],
            ),
        ),
    )
