...
@register_template(aliases=["Clamp Extremes Strobe", "clamp extremes strobe"])
def make_template() -> TemplateDoc:
    return TemplateDoc(
        template=Template(
            ...
            defaults={"dimmer_floor_dmx": 80, "dimmer_ceiling_dmx": 255},
            steps=[
                TemplateStep(
                    step_id="main",
            ...
            metadata=TemplateMetadata(
                description="Dimmer clamp stress test with aggressive strobe-like pulse.",
                recommended_sections=["drop", "peak"],
                energy_range=(70, 100),
                tags=["clamp", "strobe", "intense"],
            ),
        ),
        presets=[
            TemplatePreset(
