...
from .standards import STANDARD_POSES
...
class PoseResolver:
    ...
    def resolve_pose(self, pose_id: str | PoseID) -> tuple[float, float]:
    ...
    def get_pose(self, pose_id: str | PoseID) -> Pose:
    ...
    def list_poses(self) -> list[str]:
        ...
        """
        return [p.value if isinstance(p, PoseID) else p for p in self.poses.keys()]

    # ========================================================================
    # Private Methods
    # ========================================================================

    def _build_pose_library(self) -> dict[str | PoseID, Pose]:
        """Build complete pose library (standard + overrides + custom)."""
        poses: dict[str | PoseID, Pose] = {}
