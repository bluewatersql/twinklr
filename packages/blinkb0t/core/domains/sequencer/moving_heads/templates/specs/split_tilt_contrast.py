...
TEMPLATE = TemplateSpec(
    template_id="split_tilt_contrast",
    version=1,
    name="Split Tilt Contrast",
    ...
    steps=[
        StepSpec(
            ...
            geometry=GeometryIdSpec(
                geometry_id=GeometryID.ROLE_POSE_TILT_BIAS,
                geometry_params={
                    "pan_pose_by_role": {
                    ...
                    "tilt_pose": "HORIZON",
                    "tilt_bias_by_group": {"LEFT": -18, "RIGHT": 18},
                },
            ),
    ...
    metadata=TemplateMetadata(
        description="ROLE_POSE pan with per-group tilt bias (GEOMETRY_ID).",
        recommended_sections=["verse", "groove"],
        energy_range=[10, 40],
        tags=["geometry_id", "role_pose", "tilt_bias", "demo02b"],
    ),
)
