...
def main() -> None:
    rig = build_demo_rig()
    template = cascade_pulse_lr.TEMPLATE

    # Provide tempo so bars_to_ms is meaningful
    ...
    print("\n=== DEMO 01: Phase Offsets ===\n")
    print("Template:", template.template_id)
    print("PhaseOffset: group=ALL order=LEFT_TO_RIGHT spread_bars=1.0 wrap=True")
    print("Expected: mh1 earliest, mh4 latest (time-shifted segments)\n")
    ...
    print("\nTip: focus on t=[t0,t1] differences per fixture.\n")
