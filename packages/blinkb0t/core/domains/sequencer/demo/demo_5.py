...
def main() -> None:
    rig = build_demo_rig()
    template = floor_ceiling_demo.TEMPLATE
    ...
    print("\n=== DEMO 05: Clamp Precedence ===\n")
    print("Template:", template.template_id)
    print("Rig floor=60, Template floor=80 ceiling=220, Step floor=100 ceiling=200\n")
    ...
    print("\nTip: dimmer clamp_min/clamp_max should be 100/200.\n")
