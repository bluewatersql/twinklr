...
from blinkb0t.core.domains.sequencer.moving_heads.templates.specs import inner_pendulum_breathe


def main() -> None:
    rig = build_demo_rig()
    template = inner_pendulum_breathe.TEMPLATE
