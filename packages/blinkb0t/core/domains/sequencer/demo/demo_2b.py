...
def main() -> None:
    rig = build_demo_rig()
    template = split_tilt_contrast.TEMPLATE
    ...
    print("\n=== DEMO 02B: ROLE_POSE pan + tilt bias (GEOMETRY_ID) ===\n")
    print("Template:", template.template_id)
    print("GeometryID: ROLE_POSE_TILT_BIAS (LEFT=-18, RIGHT=+18)\n")
    ...
    print("\nTip: compare PAN vs TILT bases by side.\n")
