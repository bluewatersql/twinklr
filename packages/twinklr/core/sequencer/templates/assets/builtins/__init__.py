...
# Background Plates (6 families x 2 variants = 12 templates)
# Seam-Safe Tiles (8 families x 2 variants = 16 templates)
# Cutouts/Icons (9 families x 2 variants = 18 templates)
# Overlays/GIF (6 families x 2 variants = 12 templates)
