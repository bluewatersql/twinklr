...
def make_gtpl_base_motif_abstract_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.abstract', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
...
def make_gtpl_base_motif_geometric_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.geometric', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_spiral_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.spiral', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
...
def make_gtpl_base_motif_helix_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.helix', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.POLAR),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_radial_rays_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.radial_rays', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.POLAR),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_concentric_rings_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.concentric_rings', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.POLAR),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_wave_bands_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.wave_bands', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_zigzag_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.zigzag', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_chevrons_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.chevrons', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_stripes_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.stripes', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_gradient_bands_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.gradient_bands', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_grid_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.grid', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_checker_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.checker', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_dots_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.dots', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
