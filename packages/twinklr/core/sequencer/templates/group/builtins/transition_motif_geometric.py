...
def make_gtpl_transition_motif_gradient_bands_fade() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.gradient_bands', 'style.clean_vector', 'constraint.clean_edges', 'constraint.low_detail'],
...
def make_gtpl_transition_motif_stripes_wipe() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.stripes', 'style.clean_vector', 'constraint.clean_edges', 'constraint.low_detail'],
        avoid_tags=['constraint.noisy_texture_avoid', 'constraint.no_text'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=1, bars_max=8),
        layer_recipe=[
...
def make_gtpl_transition_motif_wave_bands_ripple() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.wave_bands', 'style.clean_vector', 'constraint.clean_edges', 'constraint.low_detail'],
        avoid_tags=['constraint.noisy_texture_avoid', 'constraint.no_text'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=1, bars_max=8),
        layer_recipe=[
...
def make_gtpl_transition_motif_cosmic_fade() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.cosmic', 'style.clean_vector', 'constraint.clean_edges', 'constraint.low_detail'],
        avoid_tags=['constraint.noisy_texture_avoid', 'constraint.no_text'],
...
def make_gtpl_transition_motif_spiral_fade() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.spiral', 'style.clean_vector', 'constraint.clean_edges', 'constraint.low_detail'],
        avoid_tags=['constraint.noisy_texture_avoid', 'constraint.no_text'],
        projection=ProjectionSpec(intent=ProjectionIntent.POLAR),
        timing=TimingHints(bars_min=1, bars_max=8),
        layer_recipe=[
...
def make_gtpl_transition_motif_helix_fade() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.helix', 'style.clean_vector', 'constraint.clean_edges', 'constraint.low_detail'],
        avoid_tags=['constraint.noisy_texture_avoid', 'constraint.no_text'],
        projection=ProjectionSpec(intent=ProjectionIntent.POLAR),
        timing=TimingHints(bars_min=1, bars_max=8),
        layer_recipe=[
...
def make_gtpl_transition_motif_grid_wipe() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.grid', 'style.clean_vector', 'constraint.clean_edges', 'constraint.low_detail'],
        avoid_tags=['constraint.noisy_texture_avoid', 'constraint.no_text'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=1, bars_max=8),
        layer_recipe=[
...
def make_gtpl_transition_motif_checker_wipe() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.checker', 'style.clean_vector', 'constraint.clean_edges', 'constraint.low_detail'],
        avoid_tags=['constraint.noisy_texture_avoid', 'constraint.no_text'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=1, bars_max=8),
        layer_recipe=[
...
def make_gtpl_transition_motif_abstract_fade() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.abstract', 'style.clean_vector', 'constraint.clean_edges', 'constraint.low_detail'],
        avoid_tags=['constraint.noisy_texture_avoid', 'constraint.no_text'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=1, bars_max=8),
        layer_recipe=[
