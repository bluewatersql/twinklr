...
def make_gtpl_rhythm_motif_lightning_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.lightning', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
...
def make_gtpl_rhythm_motif_fire_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.fire', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_ice_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.ice', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_crystals_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.crystals', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_clouds_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.clouds', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_smoke_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.smoke', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_water_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.water', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_cosmic_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.cosmic', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
...
def make_gtpl_rhythm_motif_snowflakes_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.snowflakes', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_ornaments_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.ornaments', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_candy_stripes_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.candy_stripes', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.POLAR),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
