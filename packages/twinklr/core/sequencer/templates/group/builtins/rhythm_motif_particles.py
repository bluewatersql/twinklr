...
def make_gtpl_rhythm_motif_confetti_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.confetti', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
...
def make_gtpl_rhythm_motif_particles_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.particles', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_bokeh_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.bokeh', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_sparkles_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.sparkles', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_stars_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.stars', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_light_trails_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.light_trails', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_ribbons_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.ribbons', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_flares_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.flares', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
