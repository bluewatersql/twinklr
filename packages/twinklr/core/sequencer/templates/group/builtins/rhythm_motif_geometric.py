...
def make_gtpl_rhythm_motif_abstract_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.abstract', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
...
def make_gtpl_rhythm_motif_geometric_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.geometric', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_spiral_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.spiral', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
...
def make_gtpl_rhythm_motif_helix_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.helix', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.POLAR),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_radial_rays_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.radial_rays', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.POLAR),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_concentric_rings_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.concentric_rings', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.POLAR),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_wave_bands_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.wave_bands', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_zigzag_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.zigzag', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_chevrons_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.chevrons', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_stripes_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.stripes', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_gradient_bands_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.gradient_bands', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_grid_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.grid', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_checker_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.checker', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
...
def make_gtpl_rhythm_motif_dots_drive() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.dots', 'setting.hype', 'style.bold_shapes', 'constraint.high_contrast', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=2, bars_max=32),
        layer_recipe=[
