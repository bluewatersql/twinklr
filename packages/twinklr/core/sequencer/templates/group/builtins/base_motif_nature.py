...
def make_gtpl_base_motif_lightning_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.lightning', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
...
def make_gtpl_base_motif_fire_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.fire', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_ice_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.ice', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_crystals_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.crystals', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_clouds_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.clouds', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_smoke_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.smoke', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_water_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.water', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_cosmic_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.cosmic', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
...
def make_gtpl_base_motif_snowflakes_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.snowflakes', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_ornaments_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.ornaments', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.FLAT),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
...
def make_gtpl_base_motif_candy_stripes_ambient() -> GroupPlanTemplate:
    ...
    return GroupPlanTemplate(
        ...
        affinity_tags=['motif.candy_stripes', 'style.clean_vector', 'style.bold_shapes', 'constraint.low_detail', 'constraint.clean_edges'],
        avoid_tags=['constraint.noisy_texture_avoid'],
        projection=ProjectionSpec(intent=ProjectionIntent.POLAR),
        timing=TimingHints(bars_min=4, bars_max=64),
        layer_recipe=[
