...
@register_template(aliases=["Fan Iris Tilt Bias Breathe", "fan iris tilt bias breathe"])
def make_template() -> TemplateDoc:
    return TemplateDoc(
        template=Template(
            template_id="fan_iris_tilt_bias_breathe",
            version=1,
            name="Fan Iris Tilt Bias Breathe",
            ...
            steps=[
                TemplateStep(
                    ...
                    geometry=Geometry(geometry_type=GeometryType.ROLE_POSE_TILT_BIAS),
                    movement=Movement(
                        movement_type=MovementType.FAN_IRIS,
            ...
            metadata=TemplateMetadata(
                description="Camera-iris open/close motion with tilt bias and breathing dimmer.",
                recommended_sections=["verse", "bridge"],
                energy_range=(15, 40),
                tags=["fan_iris", "tilt_bias", "breathe"],
            ),
        ),
    )
